...
public class Location
{
    ...
    public static Location Create(Location jcLocation)
    {
        return new Location{
            Name = jcLocation.Name,
            Code = jcLocation.Code,
            LocationId = jcLocation.LocationId,
            Active = jcLocation.Active,
            CourtRooms = jcLocation.CourtRooms,
            RegionCd = jcLocation.RegionCd,
            ShortName = jcLocation.ShortName
            };
    }
